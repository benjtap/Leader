      ...
      <div v-if="activeTab === 'Details'" class="details-view">
        ...
        <div class="card-section margin-top">
           <div class="section-header-row">
                ...
                <span class="manage-link">Manage fields</span>
           </div>
           
           <div class="info-row contact-content">
              <div class="info-left">
                 <span class="sub-label">Mobile</span>
                 <span class="main-text big">{{ number }}</span>
              </div>
              <div class="info-actions">
                 <!-- WhatsApp -->
                 <a :href="`https://wa.me/${number}`" target="_blank" class="action-icon whatsapp">
                 ...
                 <a :href="`sms:${number}`" class="action-icon message">
                 ...
                 <a :href="`tel:${number}`" class="action-icon phone">
        ...
        <div class="card-section">
           ...
           <div v-if="quotes && quotes.length > 0" class="quotes-list">
               <div v-for="quote in quotes" :key="quote.id" class="quote-item" @click="openQuote(quote.id)" style="display: flex; justify-content: space-between; padding: 15px 0; border-bottom: 1px solid #f0f0f0; cursor: pointer;">
                   ...
                   <div class="quote-right" style="text-align: right;">
...
const tabs = ['Details', 'Meetings', 'Call Log'];
...
const handleAction = async (action) => {
    ...
    } else if (action === 'send_card') { store.dispatch('showToast', { message: 'Business card sent (Simulated)', type: 'info' }); }
